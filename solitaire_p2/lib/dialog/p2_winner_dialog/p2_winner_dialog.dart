...
import 'package:solitaire_p2/dialog/p2_winner_dialog/p2_winner_con.dart';

class P2WinnerDialog extends P1BaseStatelessDialog<P2WinnerCon>{
  Function() close;
  Function() next;
  P2WinnerDialog({
    required this.close,
  ...
  @override
  P2WinnerCon initCon() => P2WinnerCon();
