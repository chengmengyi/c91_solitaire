...
import 'package:solitaire_p3/dialog/p3_buy_long_juan_card_dialog/p3_buy_long_juan_card_con.dart';
import 'package:solitaire_p3/hep/p3_storage.dart';

class P2BuyLongJuanDialog extends P1BaseStatelessDialog<P3BuyLongJuanCardCon>{
  Function() hasLongJuanCall;
  P2BuyLongJuanDialog({required this.hasLongJuanCall});

  @override
  P3BuyLongJuanCardCon initCon() => P3BuyLongJuanCardCon();
