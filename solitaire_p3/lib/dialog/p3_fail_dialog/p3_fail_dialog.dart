...
import 'package:solitaire_p3/dialog/p3_fail_dialog/p3_fail_con.dart';

class P2FailDialog extends P1BaseStatelessDialog<P3FailCon>{
  @override
  P3FailCon initCon() => P3FailCon();
