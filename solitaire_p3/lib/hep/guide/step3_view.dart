            ...
            Align(
              ...
              child: Container(
                ...
                child: Stack(
                  alignment: Alignment.bottomCenter,
                  children: [
                    P1Image(name: "new_guide_bg",width: double.infinity,height: 170.h,),
                    Container(
                      margin: EdgeInsets.only(left: 40.w,right: 40.w,bottom: 10.h),
                      child: P1Text(text: "Tap a card one higher or lower than the bottom card — every move gets you closer to your \$200 today.", size: 14.sp, color: "#000000",showShadows: false,height: 1.2,),
                    )
                  ],
                ),
              ),
