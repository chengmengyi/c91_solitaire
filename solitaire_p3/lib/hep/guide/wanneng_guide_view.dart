...
class WannengGuideView extends StatelessWidget{
  Offset offset;
  Function() clickCall;
  WannengGuideView({
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: P1Text(text: "Using a Wild Card allows you to eliminate any card.", size: 14.sp, color: "#000000",showShadows: false,),
                    )
                  ],
                ),
              ),
